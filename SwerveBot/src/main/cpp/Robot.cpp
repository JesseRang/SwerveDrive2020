...
private:
  ...
  void DriveWithJoystick(bool fieldRelative)
  {
    ...
    frc::SmartDashboard::PutNumber("Swerve Yaw", m_swerve.ahrs->GetYaw());
    ...
    //frc::SmartDashboard::PutNumber("FLCurrentState:", m_frontLeft.GetState())
    ...
    m_swerve.Drive(xSpeed, ySpeed, rot, fieldRelative); //field relative = true
     }
};
